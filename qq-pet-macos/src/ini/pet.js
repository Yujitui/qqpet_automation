(() => {
  ...
  global.setPetInfo = (t = {}) => {
    let {
      ...
      activeValue: h,
      fishing: f
    } = t, u = null, g = null, m = null, p = null, d = null;
    if (changeFishing = null, l) {
      for (let t in e.info) 0 == i[t] && (i[t] = 1), !l[t] && 0 !== l[t] || l[t] == e.info[t] || (n.includes(t) && !l[t] && (l[t] = "0"), g || (g = {}), g[t] = l[t], g[t] - e.info[t] > 0 && (g["add" + t] = g[t] - e.info[t]), e.info[t] = g[t]);
      for (let t in i) 0 == i[t] && (e.info[t] = "0"), i[t] = 0
    }
    if (s)
      for (let t in e.maxInfo) !s[t] && 0 !== s[t] && !1 !== s[t] || s[t] == e.maxInfo[t] || (u || (u = {}), u[t] = s[t], e.maxInfo[t] = u[t]);
    if (r)
      for (let t in e.activeOption) r[t] != e.activeOption[t] && (m || (m = {}), m[t] = r[t], e.activeOption[t] = m[t]);
    if (h)
      for (let t in e.activeValue) h[t] != e.activeValue[t] && (p || (p = {}), p[t] = h[t], e.activeValue[t] = p[t]);
    if (c)
      for (let t in e.otherOptions) null != c[t] && c[t] != e.otherOptions[t] && (d || (d = {}), d[t] = c[t], e.otherOptions[t] = d[t]);
    if (f)
      for (let t in e.fishing) null != f[t] && f[t] != e.fishing[t] && (changeFishing || (changeFishing = {}), changeFishing[t] = f[t], e.fishing[t] = changeFishing[t]);
  ...
  global.addPetInfo = t => {
    ...
    e.listenMain[n][i] && (e.listenMain[n][i] = null, delete e.listenMain[n][i])
  }, e.system = {
    doNotDisturb: !1,
    startupSelf: !1,
    opacity: 1,
    ...
    if (l) {
      e.system = l;
      if (l.opacity !== undefined) windowsMain.setOpacity(l.opacity);
      return;
    }
    if (!n) return;
    if (a) {
  ...
  let o = !1;
  global.outProjectMain = () => o, global.setOutProjectMain = e => {
    o = e
  }, e.cache = {
    gift: {
      sign: [],
  ...
  }, global.HaveUpdate = !0, global.UpdateDowning = !1, global.UpdateChecking = !1, global.HaveUpdateListen = {}, global.ChangeHaveUpdate = e => {
    HaveUpdate = e, UpdateChecking = !1;
    for (let t in HaveUpdateListen) HaveUpdateListen[t](e)
  }, global.SetHaveUpdateListen = (e, t) => {
    HaveUpdateListen[e] = t, console.log("ooo", e), HaveUpdateListen[e](HaveUpdate)
  }, module.exports = {}
})();